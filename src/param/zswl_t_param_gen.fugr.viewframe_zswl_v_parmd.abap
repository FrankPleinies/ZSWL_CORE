*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSWL_V_PARMD
*   generation date: 06.11.2020 at 12:51:52
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSWL_V_PARMD        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSWL_V_PARMD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSWL_V_PARMD_EXTRACT
TOTAL = ZSWL_V_PARMD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSWL_V_PARMD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSWL_V_PARMD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSWL_V_PARMD_EXTRACT
TOTAL = ZSWL_V_PARMD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSWL_V_PARMD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSWL_V_PARMD'
...
TOTAL = ZSWL_V_PARMD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSWL_V_PARMD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSWL_V_PARMD-UPD_FLAG NE SPACE.
