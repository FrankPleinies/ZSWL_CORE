*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSWL_V_SW_ACT
*   generation date: 31.03.2020 at 09:55:28
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSWL_V_SW_ACT       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSWL_V_SW_ACT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSWL_V_SW_ACT_EXTRACT
TOTAL = ZSWL_V_SW_ACT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSWL_V_SW_ACT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSWL_V_SW_ACT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSWL_V_SW_ACT_EXTRACT
TOTAL = ZSWL_V_SW_ACT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSWL_V_SW_ACT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSWL_V_SW_ACT'
...
TOTAL = ZSWL_V_SW_ACT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSWL_V_SW_ACT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSWL_V_SW_ACT-UPD_FLAG NE SPACE.
