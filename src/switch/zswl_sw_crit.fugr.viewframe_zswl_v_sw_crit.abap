*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSWL_V_SW_CRIT
*   generation date: 31.03.2020 at 09:58:04
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSWL_V_SW_CRIT      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSWL_V_SW_CRIT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSWL_V_SW_CRIT_EXTRACT
TOTAL = ZSWL_V_SW_CRIT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSWL_V_SW_CRIT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSWL_V_SW_CRIT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSWL_V_SW_CRIT_EXTRACT
TOTAL = ZSWL_V_SW_CRIT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSWL_V_SW_CRIT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSWL_V_SW_CRIT'
...
TOTAL = ZSWL_V_SW_CRIT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSWL_V_SW_CRIT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSWL_V_SW_CRIT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSWL_V_SW_CRIT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSWL_V_SW_CRIT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSWL_V_SW_CRIT_EXTRACT
TOTAL = ZSWL_V_SW_CRIT_TOTAL
